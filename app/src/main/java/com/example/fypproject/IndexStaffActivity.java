...
public class IndexStaffActivity extends AppCompatActivity {

    private RecyclerView recyclerView;
    private ProductStaffAdapter productAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        productAdapter = new ProductStaffAdapter(filteredProductList);
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(IndexStaffActivity.this, insertActivity.class);
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(IndexStaffActivity.this, IndexUserActivity.class);
                startActivity(intent);
                finish();
            }
        });
